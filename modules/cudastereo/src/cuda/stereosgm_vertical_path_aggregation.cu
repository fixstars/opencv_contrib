...
template CV_EXPORTS_W void aggregateUp2DownPath<64u>(
    const GpuMat& left,
    const GpuMat& right,
    GpuMat& dest,
	unsigned int p1,
...
template CV_EXPORTS_W void aggregateUp2DownPath<128u>(
    const GpuMat& left,
    const GpuMat& right,
    GpuMat& dest,
	unsigned int p1,
...
template CV_EXPORTS_W void aggregateDown2UpPath<64u>(
    const GpuMat& left,
    const GpuMat& right,
    GpuMat& dest,
	unsigned int p1,
...
template CV_EXPORTS_W void aggregateDown2UpPath<128u>(
    const GpuMat& left,
    const GpuMat& right,
    GpuMat& dest,
	unsigned int p1,
