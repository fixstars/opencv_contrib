...
template CV_EXPORTS_W void aggregateLeft2RightPath<64u>(
    const GpuMat& left,
    const GpuMat& right,
    GpuMat& dest,
	unsigned int p1,
...
template CV_EXPORTS_W void aggregateLeft2RightPath<128u>(
    const GpuMat& left,
    const GpuMat& right,
    GpuMat& dest,
	unsigned int p1,
...
template CV_EXPORTS_W void aggregateRight2LeftPath<64u>(
    const GpuMat& left,
    const GpuMat& right,
    GpuMat& dest,
	unsigned int p1,
...
template CV_EXPORTS_W void aggregateRight2LeftPath<128u>(
    const GpuMat& left,
    const GpuMat& right,
    GpuMat& dest,
	unsigned int p1,
